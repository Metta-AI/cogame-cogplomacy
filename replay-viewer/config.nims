...
switch(
  "passL",
  (&"""
  -o {distDir / "cogplomacy_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=CogplomacyReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cp_load_replay,_cp_payload_ptr,_cp_payload_len,_cp_error_ptr,_cp_error_len
  """).replace("\n", " ")
)
